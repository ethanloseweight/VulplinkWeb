...
export function Contact() {
  ...
  return <>
    <section className="page-hero contact-hero" style={settings.contact_bg ? {position:'relative',overflow:'hidden'} : undefined}>{settings.contact_bg ? <><div className="contact-hero-bg-img" style={{position:'absolute',inset:0,zIndex:0,backgroundImage:`url(${settings.contact_bg})`,backgroundSize:'cover',backgroundPosition:'center',opacity:.55}}/><div className="contact-overlay"/></> : <div className="page-hero-bg"/>}<div className="contact-hero-content"><div className="slabel">Get In Touch</div><h1>Contact <em>Us</em></h1><p>Whether purchasing or seeking after-sales support, our dedicated teams are ready to assist.</p></div></section>
