...
export function Products() {
  const { products, categories, loading, error } = useSiteData()
  ...
  return <>
    <section className="page-hero" style={{paddingBottom:40}}><div className="page-hero-bg"/><div className="slabel">Product Catalogue</div><h1>Our <em>Products</em></h1><p>Filter by category, interface, resolution or transmission type.</p></section>
