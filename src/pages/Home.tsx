...
export function Home() {
  ...
  return <>
    <section className={`hero ${settings.hero_slides.length ? 'hero-has-slides' : ''}`} aria-label="Hero">
      ...
      <div className="hero-content"><div className="hero-eyebrow"><span className="slabel">Vulplink</span></div><h1 className="hero-headline">Over a Decade of <em>Video Transmission Excellence</em></h1><p className="hero-sub">Specialising in KVM switches, video extenders, splitters and switchers — engineered in-house, backed by patents, trusted by professionals worldwide.</p><div className="hero-actions"><Link to="/product" className="btn-primary">Explore Products</Link><Link to="/contact" className="btn-ghost">Get in Touch</Link></div></div>
      <div className="hero-scroll" aria-hidden="true"><span>Scroll</span><div className="scroll-line"/></div>
    </section>

    <section className="section" id="products-overview"><div className="section-header centered reveal"><div className="slabel">Product Lines</div><h2 className="section-title">A complete video transmission product range</h2><p className="section-desc">Covering KVM switching, video extension, distribution and switching — hover over a category to explore the full line-up.</p></div>
    ...
    <section className="section-dark" id="why-us"><div className="section-header centered reveal"><div className="slabel">Core Strengths</div><h2 className="section-title">Why choose Vulplink</h2></div><div className="strength-grid">{[
